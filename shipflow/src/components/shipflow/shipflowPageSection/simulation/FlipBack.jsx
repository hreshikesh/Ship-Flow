...
export default function FlipBack({ module, flipped }) {
  // Read the link from module.button or module.href
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        {/* CTA Button — Fixed href to use linkUrl */}
        <a
          href={linkUrl}
          target="_blank"
          rel="noopener noreferrer"
          onClick={(e) => e.stopPropagation()} // Prevents flipping the card back on button click
